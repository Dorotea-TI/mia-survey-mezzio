 ...
 * 
 * @OA\Post(
 *     path="/mia_survey_done/list",
 *     summary="MiaSurveyDone List",
 *     tags={"MiaSurveyDone"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaSurveyDone")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Survey\Repository\MiaSurveyDoneRepository::fetchByConfigure($configure);
