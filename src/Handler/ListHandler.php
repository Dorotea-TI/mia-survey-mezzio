 ...
 * 
 * @OA\Post(
 *     path="/mia_survey/list",
 *     summary="MiaSurvey List",
 *     tags={"MiaSurvey"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaSurvey")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Survey\Repository\MiaSurveyRepository::fetchByConfigure($configure);
