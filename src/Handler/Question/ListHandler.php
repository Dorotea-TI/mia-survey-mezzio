 ...
 * 
 * @OA\Post(
 *     path="/mia_survey_question/list",
 *     summary="MiaSurveyQuestion List",
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaSurveyQuestion")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Survey\Repository\MiaSurveyQuestionRepository::fetchByConfigure($configure);
